return {
  custom_settings_desc="Mundo a redondado e recursos classicos",
  custom_settings_id="CUSTOM_MUNDO DOS SONHOS",
  custom_settings_name="Mundo dos Sonhos",
  custom_worldgen_desc="Mundo a redondado e recursos classicos",
  custom_worldgen_id="CUSTOM_MUNDO DOS SONHOS",
  custom_worldgen_name="Mundo dos Sonhos",
